...
public class View extends JPanel implements ActionListener {
    ...
    // que permite selecionar uma porta logica e também mostre
    ...
    public View(LinkedList<Gate> model) {
        ...
        // gráfica da porta lógica atualmente selecionada, que é
        // a primeira. Como sempre, a contagem começa de zero.
        // A implementação de GateView está logo abaixo.
        add(menu);
        addGateView(0);
